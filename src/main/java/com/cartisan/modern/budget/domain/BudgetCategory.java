...
//			Logger.getLogger().info("Finished Calculating the Budget Amount\n\n");
        ...
        throw new RuntimeException("You should not be here.  We have returned all legitimate numbers from totalAmountOfMonthlyBudget(Date, Date) in BudgetCategoryImpl.  Please contact Wyatt Olson with details on how you got here (what steps did you perform in Buddi to get this error message).");
    }
