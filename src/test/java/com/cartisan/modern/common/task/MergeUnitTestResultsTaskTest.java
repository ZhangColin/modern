...
import static org.gradle.testkit.jarjar.org.apache.commons.io.FileUtils.copyFileToDirectory;
import static org.gradle.testkit.jarjar.org.apache.commons.io.FileUtils.writeStringToFile;
...
public class MergeUnitTestResultsTaskTest {
    ...
    private void createTestResultFile(String fileName) throws IOException {
        String defaultXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"+
                "<testsuite name=\"com.cartisan.modern.account.controller.AccountAddControllerTest\" tests=\"1\" skipped=\"0\" failures=\"0\" errors=\"0\" timestamp=\"2016-11-06T10:32:48\" hostname=\"zhangjinhuadeMacBook-Pro\" time=\"0.41\">\n" +
                "   <properties/>\n" +
